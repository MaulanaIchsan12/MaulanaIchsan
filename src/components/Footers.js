  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div class="">
        ...
        <p class="mb-4">
          <a href="#!" class="text-white">Pengiriman</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-white">Pembayaran</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-white">Tentang Akun Anda</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-white">Penukaran dan Pengembalian</a>
        </p>
        <p class="mb-4">
      ...
      <div class="">
        ...
        <p class="mb-4">
          <a href="#!" class="text-white">Lokasi Toko ZYN</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-white">Whatsapp Shopping</a>
        </p>
      </div>
      <div class="">
        <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
