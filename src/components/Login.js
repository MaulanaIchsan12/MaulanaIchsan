...
function MyApp() {
    return (
      <>
      <Navbar />
        <div className="h-full bg-gray-700 w-full py-16 px-4">
            ...
            <img src={Image} alt="" />
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <div className="mt-8">
                    <a href="https://accounts.google.com/signin/v2/identifier?hl=id&continue=https%3A%2F%2Fmail.google.com&service=mail&ec=GAlAFw&flowName=GlifWebSignIn&flowEntry=AddSession">
